...
class QLearningModel_breakout_84x84x4_3_32(tf.keras.Sequential):
    def __init__(self, *args, **kwargs):
        super(QLearningModel_breakout_84x84x4_3_32, self).__init__(*args, **kwargs)
        self.add(tf.keras.Input(shape=(FRAME_SIZE_X, FRAME_SIZE_Y, WORLD_STATE_FRAMES,)))
        self.add(layers.Conv2D(32, 8, strides=4, activation='relu', name='convolution_layer1'))
...
model = QLearningModel_breakout_84x84x4_3_32()
model.summary()
...
model.save('saved/ql_model_breakout_84x84x4_3_32',
           save_format='tf',
           signatures={
