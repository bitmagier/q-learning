...
lazy_static!(
    ...
    pub static ref QL_MODEL_BALLGAME_5x5x3_4_256_PATH: PathBuf = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("tf_model/saved/ql_model_ballgame_5x5x3_4_256");
    pub static ref QL_MODEL_BALLGAME_5x5x3_4_1024_PATH: PathBuf = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("tf_model/saved/ql_model_ballgame_5x5x3_4_1024");
